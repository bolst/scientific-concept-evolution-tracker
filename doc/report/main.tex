...
A core challenge in bibliometrics and the ``Science of Science'' is understanding how scientific consensus and terminologies evolve.
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.7\linewidth]{hnsw}
  \caption{Visualization of HNSW \cite{milvus:hnsw}}
  \label{fig:hnsw}
\end{figure}
...
The hardware consists of an Intel Xeon E5-1620 v3 CPU (8 cores @ 3.50 GHz), 32GB of RAM, and a Seagate BarraCuda 20TB HDD.
